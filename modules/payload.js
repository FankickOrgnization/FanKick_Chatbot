...
function sendHelpMessage(event){
    ...
    var url = 'https://graph.facebook.com/v2.6/' + userid + '?fields=first_name,last_name,locale,timezone,gender,birthday,posts,email,id&access_token=' + fbpage_access_token + '';
